...
<head>
    ...
    <link rel="apple-touch-icon" href="../someHtml/apple-touch-icon.png">
    <link rel="icon" type="image/png" href="../someHtml/favicon-32x32.png" sizes="32x32" />
    <link rel="icon" type="image/png" href="../someHtml/favicon-16x16.png" sizes="16x16" />
    <link rel="stylesheet" href="../someHtml/css/normalize.min.css">
    <link rel="stylesheet" href="../someHtml/css/bootstrap.min.css">
    <link rel="stylesheet" href="../someHtml/css/jquery.fancybox.css">
    <link rel="stylesheet" href="../someHtml/css/flexslider.css">
    <link rel="stylesheet" href="../someHtml/css/styles.css">
    <link rel="stylesheet" href="../someHtml/css/queries.css">
    <link rel="stylesheet" href="../someHtml/css/etline-font.css">
    <link rel="stylesheet" href="../someHtml/bower_components/animate.css/animate.min.css">
    <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css">
    <script src="../someHtml/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
</head>
<body id="top">
    <!--[if lt IE 8]>
        ...
        <section class="navigation">
            <header>
                <div class="header-content">
                    <div class="logo"><a href="#"><img src="../someHtml/img/sedna-logo.png" alt="Sedna logo"></a></div>
    ...
    <section class="features section-padding" id="features">
        ...
        <div class="responsive-feature-img"><img src="../someHtml/img/devices.png" alt="responsive devices"></div>
    </section>-->
    <section class="features-extra section-padding" id="assets">
        ...
        <div class="responsive-feature-img"><img src="../someHtml/img/macbook-pro.png" alt="responsive devices"></div>-->
    ...
    <!--<section class="hero-strip section-padding">
        <div class="container">
            <div class="col-md-12 text-center">
                ...
                <div class="logo-placeholder floating-logo"><img src="../someHtml/img/sketch-logo.png" alt="Sketch Logo"></div>
            </div>
        </div>
    </section>-->
            ...
            <div class="row">
                <div class="col-md-4">
                    <article class="blog-post">
                        <figure>
                            <a href="../someHtml/img/blog-img-01.jpg" class="single_image">
                                <div class="blog-img-wrap">
                                    <div class="overlay">
                                        <i class="fa fa-search"></i>
                                    </div>
                                    <img src="../someHtml/img/blog-img-01.jpg" alt="Sedna blog image"/>
                                </div>
                            </a>
                            <figcaption>
                ...
                <div class="col-md-4">
                    <article class="blog-post">
                        <figure>
                            <a href="../someHtml/img/blog-img-02.jpg" class="single_image">
                                <div class="blog-img-wrap">
                                    <div class="overlay">
                                        <i class="fa fa-search"></i>
                                    </div>
                                    <img src="../someHtml/img/blog-img-02.jpg" alt="Sedna blog image"/>
                                </div>
                            </a>
                            <figcaption>
                ...
                <div class="col-md-4">
                    <article class="blog-post">
                        <figure>
                            <a href="../someHtml/img/blog-img-03.jpg" class="single_image">
                                <div class="blog-img-wrap">
                                    <div class="overlay">
                                        <i class="fa fa-search"></i>
                                    </div>
                                    <img src="../someHtml/img/blog-img-03.jpg" class="single_image" alt="Sedna blog image"/>
                                </div>
                            </a>
                            <figcaption>
                            <h2><a href="#" class="blog-category" data-toggle="tooltip" data-placement="top" data-original-title="See more posts">Product</a></h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flexslider">
                        <ul class="slides">
                            <li>
                                <div class="avatar"><img src="../someHtml/img/avatar.jpg" alt="Sedna Testimonial Avatar"></div>
                                <h2>"Lorem ipsum dolor sit amet, nullam lucia nisi."</h2>
                                <p class="author">Peter Finlan, Product Designer.</p>
                            </li>
                            <li>
                                <div class="avatar"><img src="../someHtml/img/mani.jpg" alt="Sedna Testimonial Avatar"></div>
                                <h2>"Nunc vel maximus purus. Nullam ac urna ornare."</h2>
                                <p class="author">Manoela Ilic, Founder @ Codrops.</p>
                            </li>
                            <li>
                                <div class="avatar"><img src="../someHtml/img/130.jpg" alt="Sedna Testimonial Avatar"></div>
    ...
    <script>window.jQuery || document.write('<script src="../someHtml/js/vendor/jquery-1.11.2.min.js"><\/script>')</script>
    <script src="../someHtml/bower_components/retina.js/dist/retina.js"></script>
    <script src="../someHtml/js/jquery.fancybox.pack.js"></script>
    <script src="../someHtml/js/vendor/bootstrap.min.js"></script>
    <script src="../someHtml/js/scripts.js"></script>
    <script src="../someHtml/js/jquery.flexslider-min.js"></script>
    <script src="../someHtml/bower_components/classie/classie.js"></script>
    <script src="../someHtml/bower_components/jquery-waypoints/lib/jquery.waypoints.min.js"></script>
